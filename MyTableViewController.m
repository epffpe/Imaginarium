...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //UIImageView *imv = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 600)];
    //imv.image = [UIImage imageNamed:@"background"];
    //[cell addSubview:imv];
    //cell.imageView.frame = CGRectMake(0, 0, 300, 300);
    cell.imageView.image = [UIImage imageNamed:@"RNR"];
